...
CREATE TABLE lesson (
    ...
    lesson_price_id VARCHAR(50) REFERENCES lesson_price_history(lesson_price_id),
    instructor_id INT NOT NULL REFERENCES instructor(instructor_id)
);

-- Skapa tabellen student_lessons
...
CREATE TABLE instrument_rental (
    ...
    instrument_id VARCHAR(50) NOT NULL,
    student_id INT NOT NULL,
    FOREIGN KEY (rental_price_id) REFERENCES rental_price_history(rental_price_id),
    FOREIGN KEY (instrument_id) REFERENCES instrument(instrument_id),
    FOREIGN KEY (student_id) REFERENCES student(student_id)
);
...
CREATE TABLE student_payment (
    ...
    FOREIGN KEY (rental_id) REFERENCES instrument_rental(rental_id),
    FOREIGN KEY (student_id) REFERENCES student(student_id)
);
